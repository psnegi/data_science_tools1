...
|        |                                  | If you haven't setup window subsystem for Linux and want to use in window see this [[https://www.youtube.com/watch?v=AX9NLxw86yc][How to Install GIT client on Windows]]                               |

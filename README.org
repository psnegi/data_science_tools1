...
** How to get terminal in Notebook and nano editor building steps
 - go to https://github.com/adamj9431/notebook_xterm and follow the step to start a terminal in notebook
 - wget https://www.nano-editor.org/dist/v3/nano-3.2.tar.xz
 - tar -xf nano-3.2.tar.xz 
 - cd for nano source * cd nano-3.2*
 - mkdir ~/.local/bin  
 - ./configure --prefix=$HOME/.local/bin
 - make 
 - make install
 - you should be able to use *nano* editor in the terminal
* Notebooks
** Jan 7
...
|       |                                        |                            |
|-------+----------------------------------------+----------------------------|
|     3 | Complete questions in [[./hws/HW3.ipynb][this]]    notebook | Thursday 31 Jan 11.59 p.m  |
|       |                                        |                            |
|-------+----------------------------------------+----------------------------|
|       |                                        |                            |
* Course Activity
...
|        |                                    |                                                                                                                                                       |
|--------+------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------|
| 28 Jan | Practice  posted notebooks         |                                                                                                                                                       |
|        | See notebooks in notebooks section |                                                                                                                                                       |
|--------+------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------|
|        |                                    |                                                                                                                                                       |

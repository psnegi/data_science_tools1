...
by Hugo Ferreira for installing Linux. **Don't install Anaconda part.**
...
*** installing packages
**This is very important step. We are tying to make sure everybody have same computing environment**

- Once at command prompt you  have to install
  + apt-get install python3-venv
- Go to the folder where you want to keep python file, notebooks related to this course.
...
After this when you run notebook you should be able to see, **RISE** slideshow extension in notebook toolbar
